...
export default class Filterizr {
    ...
    private bindEvents;
    /**
     * If it contains media it makes use of the imagesloaded npm package
     * to trigger the first render after the media have finished loading
     * in the DOM. Otherwise, overlapping can occur if the media do not
     * have the height attribute explicitly set on them.
     *
     * In case the grid contains no media, then a simple render is performed.
     */
