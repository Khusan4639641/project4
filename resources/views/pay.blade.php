			...
			<div class="row">
				<div class="col-md-8">
					<div class="payment_form_div">
						<!--<div class="d-flex mb-2 flex-column" style="display:none;">-->
						<!--	<h5 class="mb-3">Есть аккаунт? </h5>-->
						<!--	<div>-->
						<!--		<a href="#" class="main_btn py-2">Войти</a>-->
						<!--	</div>-->
						<!--</div> <!-- d-flex -->
						...
						<div class="products_list">
							...
							<div class="products_list_product">
								<div class="d-flex align-items-center">
									<div class="products_list_product_avatar" style="background-image: url(../media/{{ $image[$i] }});">
									</div> <!-- products_list_product_avatar -->

									<a href="#" class="mycard_title2" title="Адаптер Otg линия передач iopdaskd"> <span>{{ $name[$i] }}</span></a>
								</div> <!-- d-flex -->
								<div class="d-flex align-items-center">
									<h4 class="products_list_product_price">
										{{ $price[$i]*$count[$i] }} sum
										<input type="hidden" name="prod_count[{{ $i }}]" value="{{ $count[$i] }}"/>
										<input type="hidden" name="prod_id[{{ $i }}]" value="{{ $prod_id[$i] }}"/>
									</h4> <!-- products_list_product_price -->
									<div class="product_list_close">
										<img src="{{ URL::to('/') }}/images/white_close.svg" alt="">
